...
```{r}
ls("package:ggplot2")
specificcolumn <- select(mpg,'manufacturer','model','year')
```
...
Car <- mpg %>% filter(class == 'suv' | class == 'minivan')
nrow(Car)
